<nav>
  ...
  <div class="nav-wrapper">
    ...
    <ul class="right">
      ...
      <li class="hide-on-small-only"><a href="#"><span class='circle nav cyan white-text'>J</span></i></a></li>
    </ul>
  </div>
</nav>
...
<!-- <a class="waves-effect waves-light btn view" onclick="$('#modal-Often').modal('open');">Often</a> -->
<!-- Modal Often -->
<div id="modal-Often" class="modal">
  <div class="modal-footer">
    <a href="#" class=" modal-action modal-close waves-effect waves-green btn-flat">ไปยังเวอร์ชันเก่า</a>
    <a href="#" class=" modal-action modal-close waves-effect waves-green btn-flat">ยกเลิก</a>
  </div>
  <div class="modal-content">
