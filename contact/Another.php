...
<html>
 ...
 <div class="container often">
    <ul class="collection often">
      <li class='collection-item often' style="color: #616161;">รายชื่อติดต่ออื่นๆ</li>
      <?php 
          for($i=0; $i<15; $i++){
          echo "<li class='collection-item often avatar hoverable' onclick='$('#modal-Often').modal('open');''>
            <div class='row'>
              <div class='col s1'>
                <i class='material-icons circle purple'>J</i>
              </div>
              <div class='col s4'>
