  ...
  <head>
    ...
    <nav>
      <ul id="slide-out" class="side-nav fixed">
        ...
        <li class="active"><a href="Personal.php" class="waves-effect waves-teal"><i class="material-icons">label</i>Personal</a></li>
      ...
      <div class="nav-wrapper">
        <a href="#" class="brand-logo left" hide-on-med-and-down>Personal</a>
        <ul class="right">
