  ...
  <head>
    ...
    <nav>
      <ul id="slide-out" class="side-nav fixed">
        ...
        <li class="active"><a href="Bin.php" class="waves-effect waves-teal"><i class="material-icons">delete</i>ถังขยะ</a></li>
        <li class=""><a href="Personal.php" class="waves-effect waves-teal"><i class="material-icons">label</i>Personal</a></li>
      ...
      <div class="nav-wrapper">
          <a href="#" class="brand-logo left" hide-on-med-and-down>ถังขยะ</a>
          <ul class="right">
