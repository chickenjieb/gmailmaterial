...
<html>
  ...
  <ul id="slide-out" class="side-nav fixed">
      ...
      <li class="active"><a href="Work.php" class="waves-effect waves-teal"><i class="material-icons">label</i>Work</a></li>
<!--       <li class="bold"><a href="#!" class="waves-effect waves-teal">First Sidebar Link</a></li>
  ...
  <div class="nav-wrapper">
      <a href="#" class="brand-logo left" hide-on-med-and-down>Work</a>
      <ul class="right">
