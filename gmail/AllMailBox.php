...
<html>
  ...
  <ul id="slide-out" class="side-nav fixed">
      ...
      <li class="active"><a href="AllMailBox.php" class="waves-effect waves-teal"><i class="material-icons">label</i>กล่องจดหมายทั้งหมด</a></li>
      <li class="divider"></li>
  ...
  <div class="nav-wrapper">
      <a href="#" class="brand-logo left" hide-on-med-and-down>กล่องจดหมายทั้งหมด</a>
      <ul class="right">
