...
<!--       <li class="bold"><a href="#!" class="waves-effect waves-teal">First Sidebar Link</a></li>
      ...
      <li class=""><a href="JunkMail.php" class="waves-effect waves-teal"><i class="material-icons">warning</i>จดหมายขยะ</a></li>
  ...
  <div class="nav-wrapper">
      <a href="#" class="brand-logo left" hide-on-med-and-down>ความช่วยเหลือ</a>
      <ul class="right">
  ...
  <body>
    ...
    <div class="collection help" style="margin-bottom: 5px;">
      ...
      <a href="#" class="collection-item"><i class="material-icons">assignment</i>เปลี่ยนหรือรีเซ็ตรหัสผ่าน</a>
      <a href="#" class="collection-item"><i class="material-icons">assignment</i>ลงชื่อเข้าใช้ Gmail</a>
      <a href="#" class="collection-item"><i class="material-icons">assignment</i>ลบบัญชี Gmail ของคุณ</a>
      <a href="#" class="collection-item"><i class="material-icons">assignment</i>เปลี่ยนการตั้งค่า Gmail</a>
      <a href="#" class="collection-item"><i class="material-icons">assignment</i>กิจกรรมล่าสุดของบัญชี</a>
