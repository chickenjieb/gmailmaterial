...
<html>
  ...
  <ul id="slide-out" class="side-nav fixed">
      ...
      <li class="active"><a href="AllMail.php" class="waves-effect waves-teal"><i class="material-icons">email</i>อีเมลล์ทั้งหมด</a></li>
  ...
  <div class="nav-wrapper">
      <a href="#" class="brand-logo left" hide-on-med-and-down>อีเมลล์ทั้งหมด</a>
      <ul class="right">
