...
<nav>
  <ul id="slide-out" class="side-nav fixed">
      ...
      <li class="active"><a href="Important.php" class="waves-effect waves-teal"><i class="material-icons">label</i>สำคัญ</a></li>
  ...
  <div class="nav-wrapper">
      <a href="#" class="brand-logo left" hide-on-med-and-down>สำคัญ</a>
      <ul class="right">
  ...
  <body>
  <ul class="collection important">
    <li class="collection-item avatar">
      <i class="material-icons circle lime">N</i>
      <span class="title"><i class="material-icons">label</i>NCSOFT Support</span>
      <p class="date">24/04/2017<p>
      <p class="subject">NCSOFT Security Notification</p>
      <p class="content">NCSOFT Dear jutatip, your account has been accessed from an unverified location. IP Address:49.228.227.193:62106 Country: TH*</p>
