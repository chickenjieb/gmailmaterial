  ...
  <head>
    ...
    <nav>
      <ul id="slide-out" class="side-nav fixed">
        ...
        <li class="divider"></li>
        <li class="active"><a href="index.php" class="waves-effect waves-teal"><i class="material-icons">label</i>หลัก</a></li>
      ...
      <div class="nav-wrapper">
        <a href="#" class="brand-logo left" hide-on-med-and-down>หลัก</a>
        <ul class="right">
