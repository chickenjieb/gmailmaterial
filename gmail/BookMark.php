...
<nav>
  <ul id="slide-out" class="side-nav fixed">
      ...
      <li class="active"><a href="BookMark.php" class="waves-effect waves-teal"><i class="material-icons">star</i>ติดดาว</a></li>
  ...
  <div class="nav-wrapper">
      <a href="#" class="brand-logo left" hide-on-med-and-down>ติดดาว</a>
      <ul class="right">
