...
<html>
  <head>
    ...
    <nav>
      <ul id="slide-out" class="side-nav fixed">
        ...
        <li class="active"><a href="Receipts.php" class="waves-effect waves-teal"><i class="material-icons">label</i>Receipts</a></li>
        ...
        <li class=""><a href="Personal.php" class="waves-effect waves-teal"><i class="material-icons">label</i>Personal</a></li>
        <li class="active"><a href="Receipts.php" class="waves-effect waves-teal"><i class="material-icons">label</i>Receipt</a></li>
        <li class=""><a href="Travel.php" class="waves-effect waves-teal"><i class="material-icons">label</i>Travel</a></li>
        <li class=""><a href="Work.php" class="waves-effect waves-teal"><i class="material-icons">label</i>Work</a></li>
        <li class="divider"></li>
      ...
      <div class="nav-wrapper">
        <a href="#" class="brand-logo left" hide-on-med-and-down>Receipts</a>
        <ul class="right">
  ...
  <body style="background-color: #FFFFFF;">
    <div class="NoContent">
      <img src="pic/folder.png">
      <h6>ไม่มีสิ่งใดใน Receipts</h6>
    </div>
