...
<html>
  ...
  <ul id="slide-out" class="side-nav fixed">
      ...
      <li class="active"><a href="Promotion.php" class="waves-effect waves-teal"><i class="material-icons">label</i>โปรโมชัน</a></li>
...
<!--       <li class="bold"><a href="#!" class="waves-effect waves-teal">First Sidebar Link</a></li>
  ...
  <div class="nav-wrapper">
      <a href="#" class="brand-logo left" hide-on-med-and-down>โปรโมชัน</a>
      <ul class="right">
