  ...
  <head>
    ...
    <nav>
      <ul id="slide-out" class="side-nav fixed">
        ...
        <li class="active"><a href="Sent.php" class="waves-effect waves-teal"><i class="material-icons">send</i>ส่งแล้ว</a></li>
      ...
      <div class="nav-wrapper">
        <a href="#" class="brand-logo left" hide-on-med-and-down>ส่งแล้ว</a>
        <ul class="right">
