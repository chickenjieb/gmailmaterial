  ...
  <head>
    ...
    <nav>
      <ul id="slide-out" class="side-nav fixed">
        ...
        <li class="active"><a href="Forum.php" class="waves-effect waves-teal"><i class="material-icons">forum</i>ฟอรัม</a></li>
        <li class="divider"></li>
      ...
      <div class="nav-wrapper">
        <a href="#" class="brand-logo left" hide-on-med-and-down>ฟอรัม</a>
        <ul class="right">
