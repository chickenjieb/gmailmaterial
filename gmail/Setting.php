...
<!--       <li class="bold"><a href="#!" class="waves-effect waves-teal">First Sidebar Link</a></li>
  ...
  <div class="nav-wrapper">
      <a href="#" class="brand-logo left" hide-on-med-and-down>การตั้งค่า</a>
      <ul class="right">
  ...
  <body>
    <div class="collection setting">
        <a href="#" class="collection-item">การตั้งค่าทั่วไป</a>
        <a href="#" class="collection-item">chickenjieb@gmail.com</a>
        <a href="#" class="collection-item">เพิ่มบัญชี</a>
      </div>
