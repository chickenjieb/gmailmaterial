...
<html>
  ...
  <body>
    <div class="collection setting">
        ...
        <a href="#" class="collection-item"><i class="material-icons" style="color: #C0CA33;">fiber_manual_record</i>แจ้งเตือน</a>
        <ul class="collection help">
          <li class="collection-item">chickenjieb@gmail.com</li>
        </ul>
        <a href="#" class="collection-item"><i class="material-icons" style="color: #C0CA33;">fiber_manual_record</i>Samsung Calendar</a>
        <ul class="collection help">
          <li class="collection-item">เพิ่มเติม</li>
        </ul>
        <a href="#" class="collection-item"><i class="material-icons" style="color: #C0CA33;">fiber_manual_record</i>วันเกิด</a>
        <a href="#" class="collection-item"><i class="material-icons" style="color: #C0CA33;">fiber_manual_record</i>วันหยุด</a>
    </div>
