  ...
  <head>
    ...
    <nav>
      <ul id="slide-out" class="side-nav fixed">
        ...
        <li class="active"><a href="Search.php" class="waves-effect waves-teal"><i class="material-icons">search</i>ค้นหา</a></li>
        <li class="divider"></li>
        ...
        <form>
          <div class="input-field">
            <input id="search" type="search" required placeholder="ค้นหา">
