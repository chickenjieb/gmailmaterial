  ...
  <head>
    ...
    <nav>
      <ul id="slide-out" class="side-nav fixed">
        ...
        <li class="active"><a href="Day.php" class="waves-effect waves-teal"><i class="material-icons">view_day</i>วัน</a></li>
  ...
  <body style="background-color: #FFFFFF;">
    <div class="row">
      <div class="col s2 day">
        <table class="bordered day grey-text centered">
          <thead>
            <tr>
              <th><span style="font-size: 24px;">7</span><br>ศ.</th>
            </tr>
          </thead>
          <tbody>
            <?php
      ...
      <div class="col s10 day-content">
        <table class="bordered day-content">
          <tbody>
            <?php
              for($i=1; $i<=25; $i++){
                echo "<tr><td></td></tr>";
