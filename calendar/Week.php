  ...
  <head>
    ...
    <nav>
      <ul id="slide-out" class="side-nav fixed">
        ...
        <li class="active"><a href="Week.php" class="waves-effect waves-teal"><i class="material-icons">view_column</i>สัปดาห์</a></li>
      ...
      <div class="col s10 day-content">
        <table class="bordered outside-table-week">
          <thead class="outside-table-week">
            <tr>
              <th><h4>3</h4><h6>จ.</h6></th>
              <th><h4>4</h4><h6>อ.</h6></th>
              <th><h4>5</h4><h6>พ.</h6></th>
              <th><h4>6</h4><h6>พฤ.</h6></th>
